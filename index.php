                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>We assist property owners in selling their assets quickly and efficiently, providing expert guidance and support throughout the entire process.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Our team helps connect tenants with landlords, offering a seamless rental experience for both property owners and renters.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Get your property listed on our platform and reach a wider audience. We ensure your listing gains maximum visibility.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>We provide legal assistance and investment advice to help you make informed decisions on your real estate investments.</p>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <ul>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>Trusted by our clients and industry partners, we consistently strive to exceed expectations with reliable service and proven results.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>With years of experience in the industry, we ensure quality and reliability in all our real estate services.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>Our team of knowledgeable agents are dedicated to guiding you through every step of the buying, selling, or renting process.</p>
									</div>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>Let’s start with a conversation to understand your needs and goals, so we can guide you through the best options for you.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>Our team takes care of reviewing all the documents and details, ensuring everything is clear and ready for the next steps.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>Once everything is in order, we’ll help you complete the acquisition, making the process as smooth and rewarding as possible.</p>
                        </div>
                    </div>
                </div>
            </div>
